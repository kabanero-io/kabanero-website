...
$(document).ready(function() {
    ...
    $('#guide-content pre:not(.no_copy pre):not(.code_command pre):not(.hotspot pre)').each(function(i) {
        ...
        $('#guide-content pre')[i].innerHTML = $('#guide-content pre')[i].innerHTML + copy_element_to_clipboard_img; 
    });
