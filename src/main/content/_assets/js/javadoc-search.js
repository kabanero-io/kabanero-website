...
$.widget('custom.catcomplete', $.ui.autocomplete, {
    ...
    _renderItem: function(ul, item) {
        ...
        if (item.category === catSearchTags) {
            if (item.d) {
                $('<a/>').attr('href', '#').html(label + '<span class=\'searchTagHolderResult\'> (' + item.h + ')</span><br><span class=\'searchTagDescResult\'>' + item.d + '</span><br>').appendTo($li);
            } else {
                $('<a/>').attr('href', '#').html(label + '<span class=\'searchTagHolderResult\'> (' + item.h + ')</span>').appendTo($li);
            }
        } else {
