...
public class TLSFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain)
        ...
        if ("http".equals(req.getScheme())) {
          ...
          response.setHeader("Content-Security-Policy", "default-src 'self' 'unsafe-inline' marketplace.eclipse.org maxcdn.bootstrapcdn.com fonts.googleapis.com ajax.googleapis.com fonts.gstatic.com  *.githubusercontent.com api.github.com www.googletagmanager.com translate.googleapis.com translate.google.com *.gstatic.com cdn.jsdelivr.net tagmanager.google.com www.google-analytics.com cdnjs.cloudflare.com *.twitter.com *.twimg.com https://www.youtube.com data:"); // Mitigating cross site scripting (XSS) from other domains.
